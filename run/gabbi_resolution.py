...
def do_two_tar_resolution():
    ...
    # Dir where DAS .pickle is
    img_dir = os.path.join(__O_DIR, "two-tar/")

    d_dir = os.path.join(__D_DIR, "two-tar/")  # Dir for fd / md
    ...
    xs_2 = load_pickle(os.path.join(img_dir, "tar_xs.pickle"))
    ys_2 = load_pickle(os.path.join(img_dir, "tar_ys.pickle"))
    xs_1 = np.zeros_like(xs_2)
    ys_1 = np.zeros_like(ys_2)
